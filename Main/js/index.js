  ...
  CitiesSlider.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        'Elements Of A Great Web Site Design'
      ),
      React.createElement(
        'div',
...
var slides = [{
  city: 'Inviting',
  country: 'Does It Make People Want To Spend Time There?',
  img: 'http://cutezz.com/wp-content/uploads/2016/09/Stylish-Living-Room-Living-Room-Designs-With-Sofa-Corner-Luxury-Living-Rooms-Large-Decorating.jpg'
}, {
  city: 'Engaging',
  country: 'Does It Have Cool Video Content?',
  img: 'http://www.sheilanarusawa.com/wp-content/uploads/2016/05/Bedroom-Home-Theater.jpg'
}, {
  city: 'Enjoyment',
  country: 'Does It Offer A Great User Experience?',
  img: 'https://i.pinimg.com/originals/52/35/ca/5235ca43a434af1135a87f1f8a03dd49.jpg'
}, {
  city: 'Unique',
  country: 'Does It Stand Apart From The Competition?',
  img: 'https://media.licdn.com/mpr/mpr/AAEAAQAAAAAAAAnLAAAAJDEwNTRhNzI1LWMxYWQtNGMwYS1iMWQ4LTMyY2QxNzY5MGY0NQ.jpg'
}, {
  city: '#Visitors',
  country: 'Does It Generate Traffic?',
  img: 'http://cdn2.vox-cdn.com/assets/4558545/1472187414_be2451c0cd_o.jpg'
}];

ReactDOM.render(React.createElement(CitiesSlider, { slides: slides }), document.querySelector('#app'));

<!--(JavaScript example #3) The variables above were modified to use my pictures and text to create my "pitch" to potential client in the form of questions and visuals-->
<!--I did not have the time to go in and modify every heading to correspond with my data, suffice it to say "I understand the mechanics of it's operation-->